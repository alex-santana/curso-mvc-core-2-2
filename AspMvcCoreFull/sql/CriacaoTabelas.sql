...
CREATE TABLE [Endereco] (
    ...
    CONSTRAINT [FK_Endereco_Fornecedores_FornecedorId] FOREIGN KEY ([FornecedorId]) REFERENCES [Fornecedores] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20190912165350_Initial', N'2.2.6-servicing-10079');
